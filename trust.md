...
Everything here is about the documentation itself, not the product's features — a place to check
this site's own claims before trusting anything else on it.

## Where to go

- [Docs health](/docs-health/) — live counts of missing descriptions, broken links, and stale pages.
