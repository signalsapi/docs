...
Mobile phone numbers are only ever returned by {% include mobile-providers.html bold=true %} — no other
...
Open **Settings → Provider** and confirm {% include mobile-providers.html bold=true joiner="or" %} is the connected
