...
Mobile phone numbers are only ever returned by **LeadMagic**, **Tomba**, **Limadata** and **Wiza** —
no other connected people-data provider supports phone lookup, regardless of your persona or plan
settings.
...
Open **Settings → Provider** and confirm **LeadMagic**, **Tomba**, **Limadata** or **Wiza** is the
connected provider. If it's any other provider, phone lookup will never populate no matter what else you
